package com.example.myapplication.customAdapter;//package com.example.myapplication.customAdapter;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    public ImageAdapter(Context context, ArrayList<Cursor> rs) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View studentView = inflater.inflate(R.layout.item_image, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.textView.setText("Thang " + String.valueOf(month + 1) + ", nam " + String.valueOf(year + 1900));
