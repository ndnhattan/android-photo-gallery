...
public class ListAlbumImageAdapter extends RecyclerView.Adapter<ListAlbumImageAdapter.ViewHolder> {

    private ArrayList<Cursor> rs;
    private Context context;
    Fragment fragment;

    public ListAlbumImageAdapter(Context context, ArrayList<Cursor> rs, Fragment fragment) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.recyclerView.setAdapter(new GridAlbumImageAdapter(context, result, position, fragment));
