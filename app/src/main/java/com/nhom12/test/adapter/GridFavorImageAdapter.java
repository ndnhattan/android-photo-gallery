...
public class GridFavorImageAdapter extends RecyclerView.Adapter<GridFavorImageAdapter.ViewHolder>{
    private Cursor rs;
    private Context context;
    private int index;
    Fragment fragment;

    public GridFavorImageAdapter(Context context, Cursor rs, int index, Fragment fragment) {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment_Photo.index = Fragment_Favorite.indexArr.get(index) + position;
                Fragment_Photo.result = Fragment_Favorite.result;
