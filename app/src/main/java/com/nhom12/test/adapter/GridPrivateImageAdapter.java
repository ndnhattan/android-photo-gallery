...
import com.nhom12.test.Fragment_Private_Access;
...
public class GridPrivateImageAdapter extends RecyclerView.Adapter<GridPrivateImageAdapter.ViewHolder>{
    private Cursor rs;
    private Context context;
    private int index;
    Fragment fragment;

    public GridPrivateImageAdapter(Context context, Cursor rs, int index, Fragment fragment) {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment_Photo.index = Fragment_Private_Access.indexArr.get(index) + position;
                Fragment_Photo.result = Fragment_Private_Access.result;
