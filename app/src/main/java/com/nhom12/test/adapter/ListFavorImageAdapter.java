...
public class ListFavorImageAdapter extends RecyclerView.Adapter<ListFavorImageAdapter.ViewHolder> {

    private ArrayList<Cursor> rs;
    private Context context;
    Fragment fragment;

    public ListFavorImageAdapter(Context context, ArrayList<Cursor> rs, Fragment fragment) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.recyclerView.setAdapter(new GridFavorImageAdapter(context, result, position, fragment));
